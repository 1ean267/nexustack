...
fn test_openapi_3_0() {
    ...
    let schema = build_schema::<Message<i32>>(SpecificationVersion::OpenAPI3_0).unwrap();
...
fn test_openapi_3_0_with_collection() {
    ...
    let schema = build_schema_with_collection::<Message<i32>>(
...
fn test_openapi_3_1() {
    use nexustack::openapi::{SpecificationVersion, generator::build_schema};
    let schema = build_schema::<Message<i32>>(SpecificationVersion::OpenAPI3_1).unwrap();
