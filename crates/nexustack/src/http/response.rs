...
use crate::http::encoding::{DefaultEncoder, Encoder};
...
pub trait IntoResponseWithContext<S>: Sized {
    ...
    type Context: axum::extract::FromRequestParts<S>;
...
where
    ...
    <R as IntoResponseWithContext<S>>::Context: Send,
    E: IntoResponseWithContext<S>,
    <E as IntoResponseWithContext<S>>::Context: Send,
    S: Send + Sync,
{
