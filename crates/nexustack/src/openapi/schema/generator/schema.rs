...
use crate::openapi::{
    Impossible, Nop, SpecificationVersion,
    ...
    schema::{
        ...
        generator::{SchemaCollection, SchemaCollectionResolutionError},
...
///
/// # Paramaters
/// - `specification` - The `OpenAPI` specification version to target (e.g., [`SpecificationVersion::OpenAPI3_0`] or [`SpecificationVersion::OpenAPI3_1`]).
...
/// use nexustack::openapi::SpecificationVersion;
...
/// }
///
/// let schema = build_schema::<MyType>(SpecificationVersion::OpenAPI3_1);
/// ```
pub fn build_schema<T: Schema>(
    specification: SpecificationVersion,
) -> Result<spec::SchemaOrReferenceObject, DocumentGenerationError> {
...
/// let schema = build_schema_with_collection::<MyType>(SpecificationVersion::OpenAPI3_1, collection.clone());
/// ```
///
...
macro_rules! one_of {
    () => ({
        let mut one_of = spec::SchemaObject::default();
...
macro_rules! all_of {
    () => ({
        let mut all_of = spec::SchemaObject::default();
...
fn null_schema(specification: SpecificationVersion) -> spec::SchemaObject {
    match specification {
        ...
        SpecificationVersion::OpenAPI3_1 => {
            schema! {
                r#type: "null".into(),
                examples: spec::Examples::Vec(vec![JsonValue::Null]),
            }
        }
    }
}
...
pub(crate) struct StructFieldTransform<'s> {
...
impl Transform<spec::SchemaOrReferenceObject> for StructFieldTransform<'_> {
    type Output = ();
    type Error = DocumentGenerationError;

    fn transform(self, i: spec::SchemaOrReferenceObject) -> Result<Self::Output, Self::Error> {
        let mut schema = i;

        if let spec::SchemaOrReferenceObject::Schema(schema_object) = &mut schema {
        ...
        if previous.is_some() {
            ...
            return Err(DocumentGenerationError::custom(format!(
...
pub(crate) struct StructJsonSchemaBuilder {
    specification: SpecificationVersion,
    schema_collection: Option<Rc<RefCell<SchemaCollection>>>,
    id: Option<SchemaId>,
    result_schema: spec::SchemaObject,
    len: usize,
}
...
impl StructJsonSchemaBuilder {
    ...
    fn new(
        ...
        let mut result = spec::SchemaObject {
            description: description.map(Into::into),
            ..spec::SchemaObject::default()
        };
        ...
        match specification {
            ...
            SpecificationVersion::OpenAPI3_1 => {
                result.examples = examples.map(spec::Examples::Vec);
...
impl StructSchemaBuilder for StructJsonSchemaBuilder {
    ...
    type Ok = spec::SchemaOrReferenceObject;
    type Error = DocumentGenerationError;
    ...
    fn describe_field_optional<'a, F: Serialize>(
        ...
        let default = default
            ...
            .transpose()
            .map_err(DocumentGenerationError::custom)?;
        Ok(PostProcessSchemaBuilder::new(
    ...
    fn end(self) -> Result<Self::Ok, Self::Error> {
        if let Some(schema_collection) = self.schema_collection {
            ...
            if let Some(schema_id) = self.id {
                ...
                return Ok(spec::ReferenceObject {
                    r#ref: schema_ref.into(),
                    summary: None,
                    description: None,
                }
                .into());
...
pub(crate) struct TupleElementTransform<'s> {
...
impl Transform<spec::SchemaOrReferenceObject> for TupleElementTransform<'_> {
    type Output = ();
    type Error = DocumentGenerationError;
    ...
    fn transform(self, i: spec::SchemaOrReferenceObject) -> Result<Self::Output, Self::Error> {
        ...
        match &mut schema {
            spec::SchemaOrReferenceObject::Schema(schema_object) => {
                // TODO: This overrides the schema definition
                if let Some(description) = self.description {
                    schema_object.description = Some(description.into());
                }
            ...
            spec::SchemaOrReferenceObject::Reference(reference_object) => {
                if let Some(description) = self.description {
...
pub(crate) struct TupleJsonSchemaBuilder {
    specification: SpecificationVersion,
    schema_collection: Option<Rc<RefCell<SchemaCollection>>>,
    id: Option<SchemaId>,
    subschemas: Vec<spec::SchemaOrReferenceObject>,
    result_schema: spec::SchemaObject,
}
...
pub(crate) struct TupleStructJsonSchemaBuilder {
...
pub(crate) struct CombinatorSubschemaTransform<'s> {
...
impl Transform<spec::SchemaOrReferenceObject> for CombinatorSubschemaTransform<'_> {
    type Output = ();
    type Error = DocumentGenerationError;
...
pub(crate) struct CombinatorJsonSchemaBuilder {
    specification: SpecificationVersion,
    schema_collection: Option<Rc<RefCell<SchemaCollection>>>,
    description: Option<&'static str>,
    examples: Option<Vec<JsonValue>>,
...
impl CombinatorSchemaBuilder for CombinatorJsonSchemaBuilder {
    ...
    fn end(mut self) -> Result<Self::Ok, Self::Error> {
        ...
        match self.specification {
            ...
            SpecificationVersion::OpenAPI3_1 => {
                result_schema.examples = self.examples.map(spec::Examples::Vec);
            }
        }
    ...
    ($only:ident) => {{
        if let Some(only) = $only {
            ...
            for (index, variant) in only.iter().enumerate() {
                ...
                write!(f, "({variant}([eE][+-]?0+)?)").map_err(DocumentGenerationError::custom)?;
            }
...
pub(crate) struct MapKeyPatternBuilder;

fn key_must_be_a_string() -> DocumentGenerationError {
    DocumentGenerationError::custom("key must be a string")
}
...
pub(crate) struct NamedMapElementTransform<'s> {
...
impl Transform<spec::SchemaOrReferenceObject> for NamedMapElementTransform<'_> {
    type Output = ();
    type Error = DocumentGenerationError;
...
pub(crate) struct AdditionalMapElementTransform<'s> {
    schema_builder: &'s mut MapJsonSchemaBuilder,
...
impl Transform<spec::SchemaOrReferenceObject> for AdditionalMapElementTransform<'_> {
    type Output = ();
    type Error = DocumentGenerationError;
    ...
    fn transform(self, i: spec::SchemaOrReferenceObject) -> Result<Self::Output, Self::Error> {
        ...
        if let Some(key_pattern) = self.key_pattern
            && self.schema_builder.specification == SpecificationVersion::OpenAPI3_1
        {
            ...
            if let Some(mut pattern_properties) = pattern_properties {
                pattern_properties
                    ...
                    .and_modify(|entry| match entry {
                        spec::BoxSchemaOrReferenceObject::Schema(schema_object) => {
                        ...
                        spec::BoxSchemaOrReferenceObject::Reference(reference_object) => {
                            *entry =
        ...
        if let Some(additional_properties) = additional_properties {
            match additional_properties {
                spec::AdditionalProperties::Schema(schema_object) => {
                ...
                spec::AdditionalProperties::Boolean(true) => {}
                spec::AdditionalProperties::Boolean(false) => {
                    self.schema_builder.result_schema.additional_properties =
                        Some(property_schema.into());
                }
                spec::AdditionalProperties::Reference(reference_object) => {
                    self.schema_builder.result_schema.additional_properties =
...
pub(crate) enum MapElementTransform<'s> {
    Named(NamedMapElementTransform<'s>),
    Additional(AdditionalMapElementTransform<'s>),
}

impl Transform<spec::SchemaOrReferenceObject> for MapElementTransform<'_> {
    type Output = ();
    type Error = DocumentGenerationError;
...
fn serialize_key<K: Schema + serde::Serialize>(
    key: K,
) -> Result<Cow<'static, str>, DocumentGenerationError> {
    match serde_json::to_value(key).map_err(DocumentGenerationError::custom)? {
...
pub(crate) struct MapJsonSchemaBuilder {
    specification: SpecificationVersion,
    schema_collection: Option<Rc<RefCell<SchemaCollection>>>,
    id: Option<SchemaId>,
    result_schema: spec::SchemaObject,
...
impl MapJsonSchemaBuilder {
    ...
    fn new(
        ...
        let mut result_schema = spec::SchemaObject {
            description: description.map(Into::into),
            ..spec::SchemaObject::default()
        };
        ...
        match specification {
            ...
            SpecificationVersion::OpenAPI3_1 => {
                result_schema.examples = examples.map(spec::Examples::Vec);
...
pub(crate) struct StructVariantJsonSchemaBuilder<'s> {
    ...
    fn end(self) -> Result<(), Self::Error> {
        ...
        match self.enum_builder.tag {
            ...
            VariantTag::InternallyTagged { tag } => {
                ...
                if let spec::SchemaOrReferenceObject::Schema(schema_object) = &mut subschema {
...
pub(crate) struct TupleVariantJsonSchemaBuilder<'s> {
    enum_builder: &'s mut EnumJsonSchemaBuilder,
    name: &'static str,
    description: Option<&'static str>,
    deprecated: bool,
...
pub(crate) struct NewTypeVariantTransform<'s> {
...
impl Transform<spec::SchemaOrReferenceObject> for NewTypeVariantTransform<'_> {
    type Output = ();
    type Error = DocumentGenerationError;
    ...
    fn transform(self, i: spec::SchemaOrReferenceObject) -> Result<Self::Output, Self::Error> {
        ...
        match self.schema_builder.tag {
            ...
            VariantTag::InternallyTagged { tag } => {
                ...
                if let spec::SchemaOrReferenceObject::Schema(schema_object) = &subschema
                    && !schema_object
                        .r#type
                        .as_ref()
                        .is_some_and(|r#type| match r#type {
                            spec::OneOrMany::One(item) => *item == "object",
                            spec::OneOrMany::Many(items) => {
                                items.iter().any(|item| *item == "object")
                            }
                        })
                {
                    return Err(DocumentGenerationError::custom(
...
pub(crate) struct EnumJsonSchemaBuilder {
    specification: SpecificationVersion,
    schema_collection: Option<Rc<RefCell<SchemaCollection>>>,
    id: Option<SchemaId>,
    description: Option<&'static str>,
                ...
                VariantTag::ExternallyTagged => match self.specification {
                    SpecificationVersion::OpenAPI3_0 => {
                        self.subschemas.push(
                            schema! {
                                r#type: "object".into(),
                                additional_properties: spec::AdditionalProperties::Boolean(true)
                            }
                            .into(),
                        );
                    }
...
macro_rules! describe_integer {
    (
        ...
        match $self.specification {
            SpecificationVersion::OpenAPI3_0 => {
                ...
                match $min {
                    ...
                    std::ops::Bound::Excluded(min) => {
                        result.minimum = Some(serde_json::Number::from(min));
                        result.exclusive_minimum = Some(spec::EitherUntagged::Left(true));
                    }
                };
                ...
                match $max {
                    ...
                    std::ops::Bound::Excluded(max) => {
                        result.maximum = Some(serde_json::Number::from(max));
                        result.exclusive_maximum = Some(spec::EitherUntagged::Left(true));
                    }
                };
            ...
            SpecificationVersion::OpenAPI3_1 => {
                result.examples = Some(spec::Examples::Vec($examples));
                ...
                match $min {
                    ...
                    std::ops::Bound::Excluded(min) => {
                        result.exclusive_minimum =
                            Some(spec::EitherUntagged::Right(serde_json::Number::from(min)));
                    }
                };
                ...
                match $max {
                    ...
                    std::ops::Bound::Excluded(max) => {
                        result.exclusive_maximum =
                            Some(spec::EitherUntagged::Right(serde_json::Number::from(max)));
                    }
                };
            }
        }
                ...
                match $min {
                    ...
                    std::ops::Bound::Included(min) => {
                        ...
                        let min = serde_json::Number::from_f64(min.into()).ok_or_else(|| {
                            DocumentGenerationError::custom(format!(
...
pub(crate) struct NotSchemaTransform {
    specification: SpecificationVersion,
    description: Option<&'static str>,
    examples: Option<Vec<JsonValue>>,
    deprecated: bool,
...
impl Transform<spec::SchemaOrReferenceObject> for NotSchemaTransform {
    type Output = spec::SchemaOrReferenceObject;
    type Error = DocumentGenerationError;
    ...
    fn transform(self, i: spec::SchemaOrReferenceObject) -> Result<Self::Output, Self::Error> {
        ...
        match self.specification {
            ...
            SpecificationVersion::OpenAPI3_1 => {
                result.examples = self.examples.map(spec::Examples::Vec);
            }
        }
...
pub(crate) struct SeqSchemaTransform {
    specification: SpecificationVersion,
    description: Option<&'static str>,
    examples: Option<Vec<JsonValue>>,
    deprecated: bool,
...
impl Transform<spec::SchemaOrReferenceObject> for SeqSchemaTransform {
    type Output = spec::SchemaOrReferenceObject;
    type Error = DocumentGenerationError;

    fn transform(self, i: spec::SchemaOrReferenceObject) -> Result<Self::Output, Self::Error> {
        let mut result = spec::SchemaObject::default();
...
pub(crate) struct SchemaCollectionTransform {
    schema_collection: Option<Rc<RefCell<SchemaCollection>>>,
    id: Option<SchemaId>,
}
...
impl Transform<spec::SchemaOrReferenceObject> for SchemaCollectionTransform {
    type Output = spec::SchemaOrReferenceObject;
    type Error = DocumentGenerationError;
...
pub(crate) struct JsonSchemaBuilder {
    specification: SpecificationVersion,
    schema_collection: Option<Rc<RefCell<SchemaCollection>>>,
    description: Option<&'static str>,
    examples: Option<Vec<JsonValue>>,
            ...
            if let Some(schema_id) = &id {
                match schema_collection.resolve_ref(schema_id) {
                    ...
                    Err(SchemaCollectionResolutionError::ConflictingDefinition {
                        ...
                        return Err(DocumentGenerationError::conflicting_definition(
                            schema_id,
                            conflicting_callsite,
                        ));
                    }
