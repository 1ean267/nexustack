...
static EXPECTED: &str = stringify! {
    ...
    const _: () = {
        ...
        impl _nexustack::inject::FromInjector for TupleStruct {
            fn from_injector(
                ...
                _nexustack::inject::IntoConstructionResult::into_construction_result(Self (arg_0, arg_1))
            }
        }
        #[automatically_derived]
        impl _nexustack::inject::Injectable for TupleStruct {}
        #[automatically_derived]
        impl _nexustack::inject::IntoConstructionResult for TupleStruct {
