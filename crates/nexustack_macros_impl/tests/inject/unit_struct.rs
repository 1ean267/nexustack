...
static EXPECTED: &str = stringify! {
    ...
    const _: () = {
        ...
        impl _nexustack::inject::FromInjector for UnitStruct {
            fn from_injector(
        ...
        #[automatically_derived]
        impl _nexustack::inject::Injectable for UnitStruct {}
        #[automatically_derived]
        impl _nexustack::inject::IntoConstructionResult for UnitStruct {
