...
static EXPECTED: &str = stringify! {
    ...
    const _: () = {
        ...
        impl _nexustack::inject::FromInjector for Struct {
            fn from_injector(
        ...
        #[automatically_derived]
        impl _nexustack::inject::Injectable for Struct {}
        #[automatically_derived]
        impl _nexustack::inject::IntoConstructionResult for Struct {
            type Service = Struct;
